<?php
	...
	if ($qtr == 1) {
		if (file_exists('Reports/FirstQuaterFinancialReport.pdf')) {
			unlink('Reports/FirstQuaterFinancialReport.pdf');
		}
		$pdf->Output('FirstQuaterFinancialReport.pdf', 'F');
		header('location: pages/operations.php');
	}
	elseif ($qtr == 2) {
		if (file_exists('Reports/SecondQuaterFinancialReport.pdf')) {
			unlink('Reports/SecondQuaterFinancialReport.pdf');
		}
		$pdf->Output('Reports/SecondQuaterFinancialReport.pdf', 'F');
		header('location: pages/operations.php');
	}
	elseif ($qtr == 3) {
		if (file_exists('Reports/ThirdQuaterFinancialReport.pdf')) {
			unlink('Reports/ThirdQuaterFinancialReport.pdf');
		}
		$pdf->Output('Reports/ThirdQuaterFinancialReport.pdf', 'F');
		header('location: pages/operations.php');
	}
	elseif ($qtr == 4) {
		if (file_exists('Reports/FinalQuaterFinancialReport.pdf')) {
			unlink('Reports/FinalQuaterFinancialReport.pdf');
		}
		$pdf->Output('Reports/FinalQuaterFinancialReport.pdf', 'F');
		header('location: pages/operations.php');
	}
?>		