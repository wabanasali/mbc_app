...
$columnLabels = array();
if ($quater == 1) {
  $reportName = "MACEDONIA BAPTIST CHURCH FIRST QUATER EXPENDITURE REPORT FOR THE YEAR ".$year;
...
elseif ($quater == 2) {
  $reportName = "MACEDONIA BAPTIST CHURCH SECOND QUATER EXPENDITURE REPORT FOR THE YEAR ".$year;
...
elseif ($quater == 3) {
  $reportName = "MACEDONIA BAPTIST CHURCH THIRD QUATER EXPENDITURE REPORT FOR THE YEAR ".$year;
  $columnLabels[0] = 'JULY';
  ...
  $reportName = "MACEDONIA BAPTIST CHURCH FOURTH QUATER EXPENDITURE REPORT FOR THE YEAR ".$year;
...
foreach (process_month_array($raw_quaterly_exp_multi_array) as $key => $value) {
...
// var_dump('Titles array content here bellow');
