...
// var_dump($raw_month_inc_multi_array);
$reportName = "MACEDONIA BAPTIST CHURCH INCOME REPORT FOR ".$month." ".$year;

$columnLabels = array( "WEEK 1", "WEEK 2", "WEEK 3", "WEEK 4", "WEEK 5", "TOTAL");

$pr_jan_exp_multi_array = array();
foreach (process_month_array($raw_month_inc_multi_array) as $key => $value) {
